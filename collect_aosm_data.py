...
def collect_action_object_data(controller,action_object,gridSize=0.25,floorPlan='FloorPlan1', num_attempts = 2, data_dir = "./aosm_data/"):
	...
	for num in range(num_attempts):
		...
		print("================")
		pickle.dump(aosm_dict, open(data_dir + "/" + action+"_" + obj+ "_relativeangles_tester.p", "wb" ) )
...
if __name__ == "__main__":
	...
	collect_action_object_data(controller,action_object,gridSize=0.25,floorPlan=floor_scene, num_attempts = num_attempts, data_dir=data_dir)
